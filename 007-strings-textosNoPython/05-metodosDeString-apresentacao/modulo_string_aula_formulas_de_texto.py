...
# Método .format()
faturamento=1000
print('O faturamento da loja foi de {}\n'.format(faturamento)) # O faturamento da loja foi de 1000




# Método .capitalize() -> Coloca a 1ª letra Maiúscula
texto = 'lira'
print(texto.capitalize()) # Lira




# Método .casefold() -> Transforma todas as letras em minúsculas (existe lower() mas o casefold é melhor normalmente)
texto = 'Lira'
print(texto.casefold()) # lira
